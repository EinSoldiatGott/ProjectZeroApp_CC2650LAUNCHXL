...
ti.targets.arm.elf.M3.rootDir ?= C:/ti/ccsv6/tools/compiler/arm_15.12.2.LTS
...
.dlls,em3 .dlls: appBLE_UartLog.pem3

-include package/cfg/appBLE_UartLog_pem3.mak
-include package/cfg/appBLE_UartLog_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/appBLE_UartLog_pem3.dep
endif
appBLE_UartLog.pem3: package/cfg/appBLE_UartLog_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
appBLE_UartLog.pem3 package/cfg/appBLE_UartLog_pem3.c: .libraries,em3
endif

package/cfg/appBLE_UartLog_pem3.c package/cfg/appBLE_UartLog_pem3.h package/cfg/appBLE_UartLog_pem3.xdl: override _PROG_NAME := appBLE_UartLog.xem3
package/cfg/appBLE_UartLog_pem3.c: package/cfg/appBLE_UartLog_pem3.cfg
package/cfg/appBLE_UartLog_pem3.xdc.inc: package/cfg/appBLE_UartLog_pem3.xdl
package/cfg/appBLE_UartLog_pem3.xdl package/cfg/appBLE_UartLog_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/appBLE_UartLog_pem3.cfg
	-$(RM) package/cfg/appBLE_UartLog_pem3.dep
	-$(RM) package/cfg/appBLE_UartLog_pem3.c
	-$(RM) package/cfg/appBLE_UartLog_pem3.xdc.inc

clean,em3::
	-$(RM) appBLE_UartLog.pem3
.executables,em3 .executables: appBLE_UartLog.xem3

appBLE_UartLog.xem3: |appBLE_UartLog.pem3

-include package/cfg/appBLE_UartLog.xem3.mak
appBLE_UartLog.xem3: package/cfg/appBLE_UartLog_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armlnk -w -q -u _c_int00  -q -o $@ package/cfg/appBLE_UartLog_pem3.oem3   package/cfg/appBLE_UartLog_pem3.xdl --silicon_version=7M3 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
appBLE_UartLog.xem3: export C_DIR=
appBLE_UartLog.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
appBLE_UartLog.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

appBLE_UartLog.test test,em3 test: appBLE_UartLog.xem3.test

appBLE_UartLog.xem3.test:: appBLE_UartLog.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 appBLE_UartLog.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.appBLE_UartLog.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,appBLE_UartLog.xem3,*)


clean:: clean,em3

clean,em3::
	-$(RM) appBLE_UartLog.xem3
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
appBLE_UartLog_pem3.oem3,copy : package/cfg/appBLE_UartLog_pem3.oem3
appBLE_UartLog_pem3.sem3,copy : package/cfg/appBLE_UartLog_pem3.sem3
